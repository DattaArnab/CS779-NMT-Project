...
# 5. Possible Ideas
   ...
   I will cover Transformer models in the course. However, to get started, check out these tutorials: [https://mccormickml.com/tutorials/](https://mccormickml.com/tutorials/) . For the implementation, check out [HuggingFace library](https://huggingface.co/transformers/) and  [PyTorch tutorial](https://pytorch.org/tutorials/beginner/torchtext_translation_tutorial.html), [https://pytorch.org/hub/pytorch\_fairseq\_translation/](https://pytorch.org/hub/pytorch_fairseq_translation/)
